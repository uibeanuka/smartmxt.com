(function ($) {
	...
	$(document).ready(function () {
		...
		$("#loginform").on("submit", function (e) {
			...
			$("#loginform .alert-info p").html(`
		        <strong>Authenticating...</strong>
		        <svg class="spin" stroke="currentColor" fill="none" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M12 22C17.5228 22 22 17.5228 22 12H19C19 15.866 15.866 19 12 19V22Z" fill="#0dcaf0"></path><path d="M2 12C2 6.47715 6.47715 2 12 2V5C8.13401 5 5 8.13401 5 12H2Z" fill="#0dcaf0"></path></svg>
			`);
			$.ajax({
				method: "POST",
				url: $(this).prop("action"),
		...
		$("#registerform").on("submit", function (e) {
			...
			$("#registerform .alert-info p").html(`
		        <strong>Registering new user...</strong>
		        <svg class="spin" stroke="currentColor" fill="none" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M12 22C17.5228 22 22 17.5228 22 12H19C19 15.866 15.866 19 12 19V22Z" fill="#0dcaf0"></path><path d="M2 12C2 6.47715 6.47715 2 12 2V5C8.13401 5 5 8.13401 5 12H2Z" fill="#0dcaf0"></path></svg>
			`);
